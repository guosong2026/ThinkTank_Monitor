...
- **知识图谱**：分析近两个月已有AI总结的报告，展示关键词、报告及关键词共现关系
...
- 使用与AI总结相同的火山方舟配置，从每篇AI总结提取并保存10个中文关键词。
- 分析范围为最近两个日历月内录入数据库、且已有AI总结的报告。
- 同义词、年份、月份、文献类型停用词、单字词和超长关键词会在本地统一处理。
- 单篇关键词按“标题 + AI总结”的摘要指纹缓存到`report_kg_keywords`表；只有新增报告或摘要变化时才再次调用模型。
